...
// Wybierz jeden z plików csv z poprzednich æwiczeñ i stwórz rêcznie schemat danych. Stwórz DataFrame wczytuj¹c plik z u¿yciem schematu.
...
// U¿yj kilku rzêdów danych z jednego z plików csv i stwórz plik json. Stwórz schemat danych do tego pliku. Przydatny tool to sprawdzenie formatu danych. https://jsonformatter.curiousconcept.com/
...
//Wykorzystaj posiadane pliki b¹dŸ dodaj nowe i u¿yj wszystkich typów oraz ‘badRecordsPath’, zapisz co siê dzieje. Jeœli jedna z opcji nie da //¿adnych efektów, trzeba popsuæ dane.
...
//Zapisz jeden z wybranych plików do formatów (‘.parquet’, ‘.json’). SprawdŸ, czy dane s¹ zapisane poprawnie, u¿yj do tego DataFrameReader. //Opisz co widzisz w docelowej œcie¿ce i otwórz u¿ywaj¹c DataFramereader.
