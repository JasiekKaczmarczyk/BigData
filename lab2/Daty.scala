...
// MAGIC %md
// MAGIC U¿yj ka¿d¹ z tych funkcji 
...
// MAGIC %md
// MAGIC ## 1. Zmiana formatu wartoœci timestamp yyyy-MM-dd'T'HH:mm:ss 
// MAGIC `unix_timestamp(..)`
// MAGIC 
...
// MAGIC %md
// MAGIC 2. Zmieñ format zgodnie z klas¹ `SimpleDateFormat`**yyyy-MM-dd HH:mm:ss**
// MAGIC   * a. Wyœwietl schemat i dane ¿eby sprawdzicz czy wartoœci siê zmieni³y
...
// MAGIC %md
// MAGIC ## Stwórz nowe kolumny do DataFrame z wartoœciami year(..), month(..), dayofyear(..)
